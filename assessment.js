...
message['text']="Whatever";// CODE HERE
...
myFriends = ["cat","dog","mouse","rat"];// CODE HERE

// #6 Add a fifth friends name to the end of your myFriends array

myFriends.push("owl");// CODE HERE

// #7 Create a 'myArrayCopy' variable. It should equal the myArray variable. Use the built in JavaScript method to create a copy.
//DON'T TOUCH THE CODE BELOW
var myArray = [1, 2, 3, 4];
//DON'T TOUCH THE CODE ABOVE
myArrayCopy = myArray.slice(0);// CODE HERE
...
//DON'T TOUCH THE CODE ABOVE
function evensOnly() {
  var evensArray = myNumbers.filter(function(val){
    return val%2===0;
  });
  return evensArray;
};
